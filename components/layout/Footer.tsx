        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Sacramento&rsquo;s trusted electricians for panel upgrades, EV
              charger installation, whole-home rewiring, and SMUD rebates.
            </p>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-sm bg-white/10 text-gray-300 transition-colors hover:bg-brand-accent hover:text-brand-dark"
          ...
          {/* Column 2 — Services */}
          <div>
            <h3 className="font-heading mb-4 text-sm font-bold uppercase tracking-widest text-brand-accent">
              Our Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <svg className="h-4 w-4 shrink-0 text-brand-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
              ...
              <li>
                <a
                  href={`mailto:${EMAIL}`}
                  className="flex items-center gap-2 text-sm text-gray-300 transition-colors hover:text-white break-all"
                >
                  <svg className="h-4 w-4 shrink-0 text-brand-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
              ...
              <li className="flex items-start gap-2 text-sm text-gray-400">
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-brand-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
            ...
            {/* Quick nav */}
            <div className="mt-6">
              <h3 className="font-heading mb-3 text-sm font-bold uppercase tracking-widest text-brand-accent">
                Quick Links
              </h3>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <p className="text-xs text-gray-500">
            &copy; {currentYear} Peak Electrical Contractors Inc. All rights reserved.
          </p>
          <a
          ...
          >
            License #{LICENSE_NUMBER} — Verify at CSLB.ca.gov
          </a>
        </div>
      </div>
    </footer>
